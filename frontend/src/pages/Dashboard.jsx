...
const Dashboard = () => {
  ...
  return (
    <div className="min-h-screen bg-[#FDFDFD] dark:bg-slate-900 transition-colors">
      {/* Header */}
      <header className="bg-white dark:bg-slate-800 border-b border-slate-200 dark:border-slate-700 sticky top-0 z-50">
        <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
          <Link to="/" className="flex items-center gap-2" data-testid="dashboard-logo">
            ...
            <span className="text-xl font-bold text-[#0F172A] dark:text-white" style={{ fontFamily: 'Outfit, sans-serif' }}>
              VitaeCraft
            </span>
          </Link>
